            ...
            <CardContent className="p-6">
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-4">
                  ...
                  <a href="https://github.com/TianJacobs" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="GitHub">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
